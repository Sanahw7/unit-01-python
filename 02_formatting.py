...
"""
animal = "Cat" #made variable for cat

new_animal = animal. replace(Cat, Dog) #made new variable for replacement

print(new_animal) #used print function for dog
...
"""
age = 17 #made a variable for my age

name = "Sanah is" + str(age) #made variable for name and made the string connected to age

print(name) #should print Sanah is 17
